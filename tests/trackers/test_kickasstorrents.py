...
from mariner.trackers import kickasstorrents
...
class TestKickAssTorrents:
    ...
    def test_parse_number(self, engine):
        """Returns an integer out of number string."""
        assert engine._parse_number('1,000,000') == 1000000
        assert engine._parse_number('1 000 000') == 1000000
    ...
    def engine(self, monkeypatch):
        ...
        async def mock_get(*args, **kwargs):
            return """
<table class='torrents_table'><tbody><tr></tr><tr> <td> <div class="torrents_table__torrent_name"> <i class="torrents_table__media_icon kf__file"></i> <div class="text--left"> <a class="torrents_table__torrent_title" href="https://katcr.co/torrent/177934/lynda-lfcs-user-and-group-management-ubuntu.html"><b>Lynda - LFCS User and Group Management (Ubuntu)</b></a>
...
</span> in <a href="https://katcr.co/category/other.html" class="text--muted"><strong>Other</strong></a> &gt; <a href="https://katcr.co/cat/other/sub/tutorials/page/1.html" class="text--muted"> <strong>Tutorials</strong></a> </span> </div> <div class="torrents_table__actions"> <a class="button button--small" href="" title="Comments">0 <i class="kf__comment"></i></a> <a class="button button--small button--green" href="" title="Verified torrent"><i class="kf__crown"></i></a> <a class="button button--small" href="magnet:?xt=urn:btih:d86c7c89d47689a55298b2b54e00f00444b52a4a&amp;dn=Lynda+-+Building+an+Ubuntu+Home+Server&amp;xl=400198391&amp;tr=http://bt3.t-ru.org/ann?pk=24f63de2304d9bedd4e7a24dff264d37&amp;tr=http://retracker.local/announce&amp;tr=udp://tracker.coppersurfer.tk:6969/announce&amp;tr=udp://tracker.pirateparty.gr:6969/announce&amp;tr=udp://tracker.opentrackr.org:1337/announce&amp;tr=udp://eddie4.nl:6969/announce&amp;tr=udp://shadowshq.yi.org:6969/announce&amp;tr=udp://tracker.leechers-paradise.org:6969&amp;tr=udp://tracker.zer0day.to:1337/announce&amp;tr=udp://p4p.arenabg.com:1337/announce&amp;tr=udp://thetracker.org:80/announce&amp;tr=udp://9.rarbg.me:2710/announce&amp;tr=udp://9.rarbg.com:2710/announce&amp;tr=udp://9.rarbg.to:2710/announce&amp;tr=udp://inferno.demonoid.pw:3395/announce" title="Torrent magnet link"><i class="kf__magnet"></i></a></div></div></td><td class="text--nowrap text--center" data-title="Size">381.66 MB</td><td class="text--nowrap text--center" data-title="Files">29</td><td class="text--nowrap text--center" data-title="Age" title="2017-06-16 01:29:05">7 months ago</td><td class="text--nowrap text--center text--success" data-title="Seed">8</td><td class="text--nowrap text--center text--error" data-title="Leech">1</td></tr><tr></tbody></table>
                """
        monkeypatch.setattr(kickasstorrents.KickAssTorrents, 'get', mock_get)

        async def mock_get_cookie(*args, **kwargs):
            return 'key', 'value'
        monkeypatch.setattr(kickasstorrents.KickAssTorrents, 'get_cookie', mock_get_cookie)
